#!/bin/bash
#===============================================================================
# Postfix ルーティング復元スクリプト
#===============================================================================
#
# 【目的】
#   Set-PostfixRouting.sh で変更したルーティング設定を元に戻します。
#
# 【使用方法】
#   # バックアップファイルを指定して復元
#   sudo bash Restore-PostfixRouting.sh /etc/postfix/transport.backup.YYYYMMDD_HHMMSS
#
#   # 最新のバックアップを自動検出して復元
#   sudo bash Restore-PostfixRouting.sh --latest
#
# 【注意】
#   - root権限で実行
...
OUTDIR="/tmp/postfix_routing_restore_$TS"
